    ...
    <main className='mx-auto min-h-screen w-full max-w-6xl px-5 py-10 sm:px-8 sm:py-14'>
      <header className='mb-10 max-w-2xl'>
        ...
        <p className='mt-3 text-pretty leading-relaxed text-muted-foreground'>
          ...
          <span className='font-mono text-foreground'>r2b1</span> for a deep
          reddish purple — then stir in white or black to push lightness and
          saturation. <span className='font-mono text-foreground'>r2b1w1</span>,{' '}
      ...
      <footer className='mt-14 border-t border-border pt-6'>
        ...
        <p className='mt-2 max-w-3xl text-pretty text-sm leading-relaxed text-muted-foreground'>
          ...
          <span className='font-mono text-foreground'>K</span> key (black). Each
          pigment is weighted by its parts and averaged together, so the more
          parts a color has, the more it pulls the mix toward itself.
        </p>
